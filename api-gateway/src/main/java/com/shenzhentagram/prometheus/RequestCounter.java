...
public class RequestCounter {
    ...
    //Prometheus Count UserPost
    public static void countUserPostRequest(int statusCode){
        switch (statusCode){
            case 204:
                UserPostNoContentCounter.inc();
                break;
            case 201:
                UserPostCreatedCounter.inc();
                break;
            case 401:
                UserPostUnauthorizedCounter.inc();
                break;
            case 400:
                UserPostBasRequestCounter.inc();
                break;
            case 404:
                UserPostNotFoundCounter.inc();
                break;
            case 200:
                UserPostOKCounter.inc();
                break;
            case 403:
                UserPostForbiddenCounter.inc();
                break;
            case 500:
                UserPostInternalServerErrorCounter.inc();
                break;
        }
    }
    private static final Counter UserPostNoContentCounter = Counter.build()
            .name("API_Gateway_Request_UserPost_NoContent_204")
            .help("Request UserPost NoContent 204 Counter").register();
    private static final Counter UserPostCreatedCounter = Counter.build()
            .name("API_Gateway_Request_UserPost_Created_201")
            .help("Request UserPost Created 201 Counter").register();
    private static final Counter UserPostUnauthorizedCounter = Counter.build()
            .name("API_Gateway_Request_UserPost_Unauthorized_401")
            .help("Request UserPost Unauthorized 401 Counter").register();
    private static final Counter UserPostBasRequestCounter = Counter.build()
            .name("API_Gateway_Request_UserPost_BasRequest_400")
            .help("Request UserPost BasRequest 400 Counter").register();
    private static final Counter UserPostNotFoundCounter = Counter.build()
            .name("API_Gateway_Request_UserPost_NotFound_404")
            .help("Request UserPost NotFound 404 Counter").register();
    private static final Counter UserPostOKCounter = Counter.build()
            .name("API_Gateway_Request_UserPost_OK_200")
            .help("Request UserPost OK 200 Counter").register();
    private static final Counter UserPostForbiddenCounter = Counter.build()
            .name("API_Gateway_Request_UserPost_Forbidden_403")
            .help("Request UserPost Forbidden 403 Counter").register();
    private static final Counter UserPostInternalServerErrorCounter = Counter.build()
            .name("API_Gateway_Request_UserPost_InternalServerError_500")
            .help("Request UserPost InternalServerError 500 Counter").register();
